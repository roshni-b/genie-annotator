...
python ClinicalDataAnnotator -i data/data_clinical_sample_9.5-consortium.txt -o data/results/output_clinicaldata.txt -a data/results/output_maf.txt
python OncoKBPlots.py -i data/results/output_clinicaldata.txt -o data/results/output.pdf -c ONCOTREE_CODE
